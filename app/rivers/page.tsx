          ...
          <div className="container p-8 mx-auto overflow-hidden shadow-lg rounded-lg bg-blue-100 w-full mb-5">
              ...
              <div className="flex flex-wrap -mx-4">
                  ...
                  <div onClick={() => { window.location.href = 'river/ganga/haridwar'; }} style={{ cursor: 'pointer' }} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 px-4 mb-8 ">
                      <div className="card-container">
                          <div className="max-w-md mx-auto overflow-hidden shadow-lg rounded-lg border border-gray-400 card">
                              <Image className="w-full h-48 object-cover" src="https://images.unsplash.com/photo-1624807136278-e2973be118ff?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aW5kaWFuJTIwcml2ZXJ8ZW58MHx8MHx8fDA%3D" alt="River Image" />
                              <div className="p-4">
                  ...
                  <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 px-4 mb-8">
                      <div className="card-container">
                          <div className="card max-w-md mx-auto overflow-hidden shadow-lg rounded-lg border border-gray-400">
                              <Image className="w-full h-48 object-cover" src="https://w0.peakpx.com/wallpaper/468/103/HD-wallpaper-sangam-bridge-ganga-morning-river-yamuna.jpg" alt="River Image" />
                              <div className="p-4">
                  ...
                  <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 px-4 mb-8">
                      <div className="card-container">
                          <div className="max-w-md mx-auto overflow-hidden shadow-lg rounded-lg border border-gray-400 card">
                              <Image className="w-full h-48 object-cover" src="https://thumbs.dreamstime.com/b/bhagirathi-river-flows-dev-prayag-uttarakhand-india-pristine-town-devprayag-nestled-holy-confluence-alaknanda-221637283.jpg" alt="River Image" />
                              <div className="p-4">
                  ...
                  <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 px-4 mb-8">
                      <div className="card-container">
                          <div className="card max-w-md mx-auto overflow-hidden shadow-lg rounded-lg border border-gray-400">
                              <Image className="w-full h-48 object-cover" src="https://images.unsplash.com/photo-1579609838707-12cd362e2597?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8bWFoYWJhbGVzaHdhciUyQyUyMGluZGlhfGVufDB8fDB8fHww" alt="River Image" />
                              <div className="p-4">
                  ...
                  <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 px-4 mb-8">
                      <div className="card-container">
                          <div className="card max-w-md mx-auto overflow-hidden shadow-lg rounded-lg border border-gray-400">
                              <Image className="w-full h-48 object-cover" src="https://images.indianexpress.com/2021/12/231956895_1487743251572212_9074142431837940104_n.jpg" alt="River Image" />
                              <div className="p-4">
                  ...
                  <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 px-4 mb-8">
                      <div className="card-container">
                          <div className="card max-w-md mx-auto overflow-hidden shadow-lg rounded-lg border border-gray-400">
                              <Image className="w-full h-48 object-cover" src="https://thumbs.dreamstime.com/b/beautiful-view-river-godavari-ghat-religious-buildings-nashik-state-maharashtra-india-top-view-sacred-river-ghat-216492399.jpg" alt="River Image" />
                              <div className="p-4">
                  ...
                  <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 px-4 mb-8">
                      <div className="card-container">
                          <div className="card max-w-md mx-auto overflow-hidden shadow-lg rounded-lg border border-gray-400">
                              <Image className="w-full h-48 object-cover" src="https://media-cdn.tripadvisor.com/media/photo-s/0d/bf/8a/d6/minavali-ghat.jpg" alt="River Image" />
                              <div className="p-4">
